...
@section('wfPage', '688e50676f1dbd8cba0e091a')
...
@section('content')
          ...
          <div class="w-layout-grid grid-2-columns listing-grid sidebar-left{{ $hasSidebarSeries ? '' : ' is-full-main' }}">
            ...
            <div id="w-node-_6804bfc1-2fcb-3b18-3dd1-06afc16e9fed-ba0e091a" class="inner-container _690px _100-tablet left-sidebar">
              <div class="windows-types-header">
                ...
                <h1 class="display-8 mid types">{{ $name }}<span class="h1-subline">Installation &amp; Replacement | Bay Area</span></h1>
    ...
    <section class="section top-none">
      <div class="w-layout-blockcontainer container-default w-container">
        <div class="title-left---content-right">
          <h2 class="heading-20">More {{ $brandName }} Door Types</h2>
        </div>
        <div class="mg-top-large">
          <div class="w-dyn-list">
            ...
            <div class="form-block-2 w-form">
              <form id="email-form-2" name="email-form-2" data-name="Email Form 2" method="get" class="form-3" data-wf-page-id="688e50676f1dbd8cba0e091a" aria-label="Email Form 2">
                <div class="div-block-22">
                  ...
                  <label for="email-banner" class="body-14"><em class="italic-text">Offer Expires </em><span class="date-span italic-span">{{ promotion_date('us-short') }}</span></label>
