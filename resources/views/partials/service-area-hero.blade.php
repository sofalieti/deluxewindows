                  ...
                  <div class="inner-container _400px---mbl">
                    <div class="div-block-60">
                      ...
                      <div class="code-embed-6 w-embed">
                        <h1 class="heading-4">
                          Windows &amp; Doors in <span class="city-highlight">@if(!empty($countyName)){{ $cityName }}, {{ $countyName }}@else{{ $cityLabel }}@endif</span><span class="h1-subline">Installation &amp; Replacement</span>
                        </h1>
                      </div>
