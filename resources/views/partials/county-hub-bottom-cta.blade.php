          ...
          <div class="w-layout-grid grid-547">
            <div class="div-block-69">
              <div class="bottomfont w-embed">
                <h3 class="faqs-title" style="color:#fff;">Ready to Replace Your Windows in {{ $ctaLocationLabel ?? $countyName ?? '' }}?</h3>
            ...
            <div class="div-block-68">
              ...
              <div class="code-embed-12 w-embed">
                Or call us directly
                <h3 class="faqs-title" style="color:#fff;">✆ (888) 730-4144</h3>
              </div>
            </div>
          </div>
        </div>
