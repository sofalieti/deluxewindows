...
@section('title', 'Collections Tabs Template')

@section('content')
<div class="container py-4">
    <h1 class="mb-2">Collections Tabs Template</h1>
    <p class="text-secondary mb-4">Webflow slug: <code>detail_collections-tabs</code> | Path: <code>/collections-tabs</code></p>
