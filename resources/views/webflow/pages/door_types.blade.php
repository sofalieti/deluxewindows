...
@section('title', 'Door Types Template')

@section('content')
<div class="container py-4">
    <h1 class="mb-2">Door Types Template</h1>
    <p class="text-secondary mb-4">Webflow slug: <code>detail_door-types</code> | Path: <code>/door-types</code></p>

    <section class="mb-3">{!! '<div class="display-4 mid">Get Deluxe Windows for Less. 40% OFF* Windows</div>' !!}</section>
    <section class="mb-3">{!! '<p class="text-titles"><em data-w-id="b0ccc805-e3e5-4986-b1fb-3494e5e5266f">Request a FREE No-Obligation Quote &amp; Expert Advice!</em><br data-w-id="b0ccc805-e3e5-4986-b1fb-3494e5e52671"></p>' !!}</section>
    ...
    <section class="mb-3">{!! '<div class="display-1">Thank you! We’ll get back to you soon<br data-w-id="b0ccc805-e3e5-4986-b1fb-3494e5e5268f"></div>' !!}</section>
    ...
    <section class="mb-3">{!! '<h2 class="heading-26">Your dream home starts here.</h2>' !!}</section>
    ...
    <section class="mb-3">{!! '<label for="email-banner" class="body-14"><em class="italic-text" data-w-id="2cf9c74b-fff0-5ba6-8394-2aca8078b3aa">*Full Home Siding. Offer Expires 7/30/25</em></label>' !!}</section>
