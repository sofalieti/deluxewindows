...
@section('title', 'Window Styles Template')

@section('content')
<div class="container py-4">
    <h1 class="mb-2">Window Styles Template</h1>
    <p class="text-secondary mb-4">Webflow slug: <code>detail_window-styles</code> | Path: <code>/window-styles</code></p>

    <section class="mb-3">{!! '<div class="display-4 mid">Get Deluxe Windows for Less. 40% OFF* Windows</div>' !!}</section>
    <section class="mb-3">{!! '<p class="text-titles"><em data-w-id="8a39644a-e4c7-3a3e-4580-065ef6587c73">Request a FREE No-Obligation Quote &amp; Expert Advice!</em><br data-w-id="8a39644a-e4c7-3a3e-4580-065ef6587c75"></p>' !!}</section>
    ...
    <section class="mb-3">{!! '<div class="display-1">Thank you! We’ll get back to you soon<br data-w-id="8a39644a-e4c7-3a3e-4580-065ef6587c93"></div>' !!}</section>
    <section class="mb-3">{!! '<div>Oops! Something went wrong.</div>' !!}</section>
    <section class="mb-3">{!! '<div>No items found.</div>' !!}</section>
    <section class="mb-3">{!! '<h2 class="heading-10">4 Easy Steps</h2>' !!}</section>
    ...
    <section class="mb-3">{!! '<h2 class="heading-40">Your dream home starts here.</h2>' !!}</section>
    ...
    <section class="mb-3">{!! '<label for="email-banner" class="body-14"><em class="italic-text" data-w-id="e68c25ea-b207-46ee-3487-9c4c8928b92b">*Full Home Siding. Offer Expires 7/30/25</em></label>' !!}</section>
