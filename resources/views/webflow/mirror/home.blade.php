...
body.mobile-menu-open .w-nav-overlay .w-nav-menu {
...
</style></div></div><div class="div-block-59"><div class="code-embed-5 w-embed w-script"><style>
  /* Контейнер для фона */
  .video-bg-container {
    position: absolute;
  ...
  /* Чтобы видео заполняло весь блок без черных полос */
  .video-bg-container video {
    width: 100%; height: 100%; object-fit: cover;
  }
</style>

<div id="hero-bg-wrapper" class="video-bg-container"></div>
