@php
    /** @var \Illuminate\Support\Collection<int, \App\Models\ContactChange>|\App\Models\ContactChange[] $changes */
    $changes = $changes ?? collect();
@endphp

<div class="bg-white rounded shadow-sm p-4 mb-3 contact-history">
    <h6 class="text-muted text-uppercase mb-3 contact-panel__title">Change history</h6>
