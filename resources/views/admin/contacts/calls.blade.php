...
<div class="bg-white rounded shadow-sm p-4 mb-3 contact-calls">
    ...
    @if ($phone === '')
        <p class="text-muted mb-0">Add a phone number to this contact to see matching call history.</p>
    @else
        ...
        @empty
            <p class="text-muted mb-0">No RingCentral calls found for this phone number yet.</p>
        @endforelse
    @endif
</div>
