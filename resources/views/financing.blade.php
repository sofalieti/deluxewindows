                  ...
                  <div class="product-card---bottom-content">
                    ...
                    <div class="div-block-38">
                      <div class="w-layout-grid grid-1-column gap-row-16px">
                        ...
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan"></div><div class="display-2">Fast &amp; Simple Approval<br/></div></div>
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan"></div><div class="display-2">Improve Home Value Now<br/></div></div>
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan"></div><div class="display-2">Second Chance Financing<br/></div></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card plan-card">
                  ...
                  <div class="product-card---bottom-content">
                    ...
                    <div class="div-block-40">
                      <div class="w-layout-grid grid-1-column gap-row-16px">
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan"></div><div class="display-2">Custom Repayment Plans<br/></div></div>
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan"></div><div class="display-2">More Buying Power<br/></div></div>
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan"></div><div class="display-2">Up to 30-Year Terms<br/></div></div>
