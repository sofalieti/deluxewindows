                  ...
                  <div class="product-card---bottom-content">
                    ...
                    <div class="div-block-38">
                      <div class="w-layout-grid grid-1-column gap-row-16px">
                        ...
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan" aria-hidden="true">&#xE82F;</div><div class="display-2">Fast &amp; Simple Approval<br/></div></div>
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan" aria-hidden="true">&#xE82F;</div><div class="display-2">Improve Home Value Now<br/></div></div>
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan" aria-hidden="true">&#xE82F;</div><div class="display-2">Second Chance Financing<br/></div></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card plan-card">
                  ...
                  <div class="product-card---bottom-content">
                    ...
                    <div class="div-block-40">
                      <div class="w-layout-grid grid-1-column gap-row-16px">
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan" aria-hidden="true">&#xE82F;</div><div class="display-2">Custom Repayment Plans<br/></div></div>
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan" aria-hidden="true">&#xE82F;</div><div class="display-2">More Buying Power<br/></div></div>
                        <div class="feature-wrapper dark v1"><div class="check-icon feature-plan" aria-hidden="true">&#xE82F;</div><div class="display-2">Up to 30-Year Terms<br/></div></div>
          ...
          <div class="w-layout-blockcontainer container-default w-container">
            <div class="inner-container _750px---tablet center">
              <div class="mg-top-large">
                <div data-current="Tab 1" data-easing="ease" data-duration-in="300" data-duration-out="100" class="tabs-wrapper---v3 w-tabs">
                  <div class="tabs-menu---v3 w-tab-menu">
                    <a data-w-tab="Tab 1" class="card proccess-card-v3 w-inline-block w-tab-link w--current">
                      <div>
                        <div class="accordion-top">
                          <div class="inner-container _350px">
                            <div class="inner-container _300px---mbl"><h3 class="faqs-title">Apply</h3></div>
                          </div>
                        ...
                        <div class="accordion-bottom v2">
                          <p class="accordion-paragraph">Select Deluxe Windows who will help you through the process every step of the way.</p>
                        </div>
                      </div>
                    </a>
                    <a data-w-tab="Tab 2" class="card proccess-card-v3 w-inline-block w-tab-link">
                      <div>
                        <div class="accordion-top">
                          <div class="inner-container _350px">
                            <div class="inner-container _300px---mbl"><h3 class="faqs-title">Sign</h3></div>
                          </div>
                          <div class="accordion-icon-wrapper">
                            <div class="accordion-icon-line vertical"></div>
                            <div class="accordion-icon-line"></div>
                        ...
                        <div class="accordion-bottom v2">
                          <p class="accordion-paragraph">Sign financing documents electronically.No need to go to the bank.</p>
                        </div>
                      </div>
                    </a>
                    <a data-w-tab="Tab 3" class="card proccess-card-v3 w-inline-block w-tab-link">
                      <div>
                        <div class="accordion-top">
                          <div class="inner-container _350px">
                            <div class="inner-container _300px---mbl"><h3 class="faqs-title">Install</h3></div>
                          </div>
                          <div class="accordion-icon-wrapper">
                            <div class="accordion-icon-line vertical"></div>
                            <div class="accordion-icon-line"></div>
                        ...
                        <div class="accordion-bottom v2">
                          <p class="accordion-paragraph">Deluxe Windows will install your energy efficient windows and doors.<br/></p>
                        </div>
                      </div>
                    </a>
                  </div>
                    ...
                    <div class="inner-container _480px">
                      <div class="inner-container _450px">
                        <div class="inner-container _300px---mbp">
                          <div class="mg-top-small">
                            <h2 class="heading-29">Your Dream Home Starts Here.</h2>
                          </div>
                        </div>
                      </div>
                      <div class="mg-top-small">
                      ...
                      <div class="mg-top-default">
                        <div class="buttons-row left">
                          <a href="#wf-form-Contact-V1-Form" class="primary-button w-inline-block">
                            <div class="text-block">Free Consultation</div>
                          </a>
                        </div>
                      </div>
                    </div>
            ...
            <div class="w-layout-grid grid-2-columns contact-grid-v2">
              ...
              <div class="inner-container _659px width-100 _100-tablet">
                <div class="card form-wrapper">
                  <div class="form-wrapper-v1 w-form">
                    <form id="wf-form-Contact-V1-Form" name="wf-form-Contact-V1-Form" data-name="Contact V1 Form" method="get" class="form" data-wf-page-id="6841ddf8ace3d9d9facb1672">
                      <div class="w-layout-grid grid-form">
                        ...
                        <div class="text-area-wrapper">
                          <label for="message">Listing short description</label>
                          <div class="input-wrapper">
                    ...
                    <div class="error-message-wrapper w-form-fail"><div>Oops! Something went wrong.</div></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card accordion-card v2">
                <div class="w-layout-grid grid-1-column accordion-v6">
                  <div class="accordion-item-wrapper v2 first">
                    <div class="accordion-top">
                      <div class="text-titles"><h3 class="faqs-title">Which material is best for your windows?<br/></h3></div>
                      <div class="accordion-icon-wrapper">
                        <div class="accordion-icon-line vertical"></div>
                        <div class="accordion-icon-line"></div>
                      </div>
                  ...
                  <div data-w-id="5e6fa5f4-992b-f428-8721-43b1fd267cb8" class="accordion-wrapper">
                    <div class="accordion-item-wrapper v2">
                      ...
                      <div class="accordion-bottom v1">
                        <p class="accordion-paragraph">To get a free consultation, please fill out the <a href="#wf-form-Contact-V1-Form">form</a>.</p>
                      </div>
                    </div>
                  </div>
