...
return new class extends Migration
{
    ...
    {
        Schema::create('wf_door_types', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('wf_door_type_collections_2')->nullable();
            $table->text('wf_explore_collection_text')->nullable();
    ...
    {
        Schema::dropIfExists('wf_door_types');
    }
};
